...
/**
 * Holds the data for a given annotation in an {@link au.aklein.metajava.internal.AnnotationAttribute}
 */
...
public final class AnnotationData {
    ...
    public AnnotationData(String type,
    ...
    public Map<String, ElementValue> getElementValuePairs() {
